...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // splitwiseService.createSplitBill(user3, Arrays.asList(user2) , service.splitwise.domain.SplitType.SPLIT_TYPE_EQUAL, 1000.0f, null);
        // splitwiseService.getCompleteDebt();


        // splitwiseService.createSplitBill(user4, Arrays.asList(user2) , service.splitwise.domain.SplitType.SPLIT_TYPE_EQUAL, 200.0f, null);
        // splitwiseService.GetDebtByUserId(user4);
        // splitwiseService.GetDebtByUserId(user1);
        // splitwiseService.CreateSplitBill(user1, Arrays.asList(user2, user3) , service.splitwise.domain.SplitType.SPLIT_TYPE_EXACT, 1250.0f, Arrays.asList(370.0f, 880.0f));
        // splitwiseService.GetDebtByUserId(user1);
    }
}
